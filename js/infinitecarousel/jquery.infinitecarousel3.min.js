    ...
    a.fn.extend({
        infiniteCarousel: function (b) {
            ...
            return this.each(function () {
                ...
                a(r).append('<div class="ic_left_nav" style="position:absolute;left:0;width:32px;opacity:0;top:' + (F / 2 - 16) + 'px;">').append('<div class="ic_right_nav" style="position:absolute;width:32px;right:0;opacity:0;top:' + (F / 2 - 16) + 'px;">');
