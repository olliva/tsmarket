    ...
    a.fn.extend({
        infiniteCarousel: function (b) {
            ...
            return this.each(function () {
                ...
                for (var C = 0; C < s; C++) {
                    a("div.ic_tray", r).append('<div style="overflow:hidden;background:url(' + w.imagePath + "wait.gif) no-repeat scroll 50% 50% #ddd;float:left;position:relative;width:" + v + "px;height:" + F + 'px;" class="infiniteCarousel_item">')
                }
                ...
                a(".ic_tray", r).prepend(a(".infiniteCarousel_item:last", r).remove());
                if (w.margin != 0) {
                ...
                a(r).append('<div class="ic_left_nav" style="position:absolute;left:0;width:32px;opacity:0;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);top:' + (F / 2 - 16) + 'px;">').append('<div class="ic_right_nav" style="position:absolute;width:32px;right:0;filter:progid:DXImageTransform.Microsoft.Alpha(opacity=0);top:' + (F / 2 - 16) + 'px;">');
                ...
                if (!w.prevNextInternal && (parseInt(a(r).css("border-left-width")) + parseInt(a(r).css("border-right-width"))) > 0) {
                    a(".ic_right_nav", r).css("right", "0" + "px")
                }
                ...
                function B() {
                    ...
                    if (w.thumbnailType == "count") {
                        var J = [];
                        for (var u = thumbButtonStart; u < thumbButtonStart + w.inView; u++) {
